...
// heightmap represents a 2D map to be filled by diamond square algorithm.
type heightmap [][]float64

// Function GenMap fills the contents of a heightmap "hmap" with values generated by the diamond square algorithm.
// The "h" parameter must be between 0 and 1. Values closer to 1 generate smoother terrain, values closer to 0 generate rougher terrain.
...
// Function "GetGrayImage" returns *image.Gray representation of heightmap
// Value 0 is mapped to 0. Value 1 is mapped to 255. Values in between are interpolated.
